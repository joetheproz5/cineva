// Forward /assets/* requests to vidking.net so the proxied player's runtime assets resolve.
...
export async function onRequestGet(context) {
  ...
  const target = `${ORIGIN}/assets/${rest}${new URL(context.request.url).search}`;
  try {
