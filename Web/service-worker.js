const VERSION = "seven-v259";const DATA_CACHE = "seven-data-v1";
const IMAGE_CACHE = "seven-images-v1";
const SHELL = ["./", "index.html", "styles.css?v=234", "auth.css?v=235", "ui.css?v=257", "player-security.js?v=245", "app.js?v=248", "manifest.webmanifest", "icon.svg", "assets/seven-logo-red.png", "assets/avatars/red-panda.png", "assets/avatars/black-cat.png", "assets/avatars/astronaut.png", "assets/avatars/duck.png", "assets/avatars/robot.png"];
