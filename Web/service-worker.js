const VERSION = "seven-v233";const DATA_CACHE = "seven-data-v1";
const IMAGE_CACHE = "seven-images-v1";
const SHELL = ["./", "index.html", "styles.css?v=233", "auth.css?v=233", "ui.css?v=233", "player-security.js?v=233", "app.js?v=233", "manifest.webmanifest", "icon.svg", "assets/seven-logo-red.png", "assets/seven-wordmark-v2.png", "assets/avatars/red-panda.png", "assets/avatars/black-cat.png", "assets/avatars/astronaut.png", "assets/avatars/duck.png", "assets/avatars/robot.png"];
