const VERSION = "seven-v255";const DATA_CACHE = "seven-data-v1";
const IMAGE_CACHE = "seven-images-v1";
const SHELL = ["./", "index.html", "styles.css?v=234", "auth.css?v=234", "ui.css?v=255", "player-security.js?v=245", "app.js?v=245", "manifest.webmanifest", "icon.svg", "assets/seven-logo-red.png", "assets/avatars/red-panda.png", "assets/avatars/black-cat.png", "assets/avatars/astronaut.png", "assets/avatars/duck.png", "assets/avatars/robot.png"];
