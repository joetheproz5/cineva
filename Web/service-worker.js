const VERSION = "seven-v202";
const DATA_CACHE = "seven-data-v1";
const IMAGE_CACHE = "seven-images-v1";
const SHELL = ["/", "/index.html", "/styles.css?v=202", "/auth.css?v=202", "/ui.css?v=202", "/app.js?v=202", "/manifest.webmanifest", "/icon.svg", "/assets/seven-logo-red.png", "/assets/seven-wordmark-v2.png",  "/assets/avatars/red-panda.png", "/assets/avatars/black-cat.png", "/assets/avatars/astronaut.png", "/assets/avatars/duck.png", "/assets/avatars/robot.png"];
