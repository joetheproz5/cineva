...
function providerMenuHTML() {
  const labels = { vidlink:"VidLink", vidking:"Vidking", vidsrc:"VidSrc", "2embed":"2Embed" }, current = selectedPlayerProvider();
