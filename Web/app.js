...
function header() {
  ...
  const account = !settingsMode && state.user ? `<button class="account signed-in" data-account title="Account">${profileAvatar(profile)}</button>` : !settingsMode ? `<button class="account" data-auth aria-label="Open account"><span>◉</span><b>${t("Account")}</b></button>` : "";
