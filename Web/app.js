...
if ("serviceWorker" in navigator) {
  navigator.serviceWorker.register("/service-worker.js?v=195").catch(() => { /* The app keeps working from the network when registration fails. */ });
}
